...
subtitle: "An Analysis of Trends in Bird Obervations and Temperature in North Carolina, 2010-2020"
author: "Cate Jaffe"
date: "4/26/2021"
output: pdf_document
editor_options:
...
### Data Cleaning
```{r bird data clean, echo=TRUE, message=FALSE, warning=FALSE, fig.cap = "A comparison of Bird observations, raw data (left) and log transformed (right). Log transformed data have a more normal distribution"}
...
## Data Exploration
```{r bird exploratory plots, fig.cap="The top plot is raw bird observation data, the bottom plot is observations per minute of observation.", fig.height=8,  fig.width = 8}
...
```{r Visualize first and last observation dates, echo=TRUE, fig.cap="Seasonal Stays of Birds in North Carolina", message=FALSE, warning=FALSE, fig.height=8, fig.width=10}
